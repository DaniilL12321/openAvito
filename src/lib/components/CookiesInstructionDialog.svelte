...
>
	<div
		class="fixed bottom-0 z-[80] w-full overflow-y-auto rounded-t-3xl border bg-background p-0 shadow-lg duration-200 md:bottom-auto md:left-[50%] md:top-[50%] md:h-auto md:w-[calc(100vw-2rem)] md:max-w-xl md:translate-x-[-50%] md:translate-y-[-50%] md:rounded-3xl"
	...
	>
		...
		<div class="space-y-6 p-4 pb-24 md:pb-8 lg:p-8">
			<div class="space-y-4">
				<div class="space-y-2">
					...
					<div class="space-y-2 text-sm text-muted-foreground">
						<p class="flex items-start gap-2">
							...
							<span
								>Cookies устарели или были очищены. В этом случае нужно обновить их
								значение в настройках.</span
							>
						</p>
						<p class="flex items-start gap-2">
							<span class="text-foreground">2.</span>
							<span
								>Слишком много запросов с вашего IP. В этом случае нужно пройти
								капчу на сайте Авито.</span
							>
						</p>
					</div>
				</div>
				...
				<div class="space-y-2">
					...
					<div class="space-y-2 text-sm">
						<p class="flex items-start gap-2">
							<span class="text-foreground">1.</span>
							<span>
								Откройте Авито и пройдите капчу, если она появится. После этого
								вернитесь сюда и попробуйте снова.
							</span>
						</p>
						<p class="flex items-start gap-2">
							<span class="text-foreground">2.</span>
							<span> Если проблема повторяется: </span>
						</p>
